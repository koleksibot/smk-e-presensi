            ...
            <div class="row">
                <div class="col-12 col-md col-lg">
                    <div class="card">
                        ...
                        <form id="formUbahPassword" action="<?= base_url('admin/ubah_password') ?>" method="POST">
                            <div class="card-body mb-1">
                                ...
                                <div class="form-group row justify-content-center mb-2">
                                    <label for="konfirmasi_pasoword" class="col-sm-2 col-form-label">Konfirmasi Password</label>
                                    <div class="col-sm-5">
