            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/data_master/kelas/tambah') ?>" method="POST" class="row justify-content-center">
                                <div class="col-lg-5 col-md-7 col-sm-12">
                                    <div class="form-group">
                                        <label for="">Nama Kelas</label>
                                        <input class="form-control" type="text" name="namaKelas" value="<?= set_value('namaKelas') ?>" placeholder="Masukkan nama kelas" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jurusan" class="form-control">
                                            ...
                                            <?php foreach ($jurusan as $jrsn) : ?>
                                                <option value="<?= $jrsn['id_jurusan'] ?>" <?= set_select('jurusan', $jrsn['id_jurusan']) ?>><?= $jrsn['nama_jurusan'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
