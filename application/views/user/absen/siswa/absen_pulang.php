                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-sm-12 col-lg-6">
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="nisn" class="form-control" readonly value="<?= $absen['nisn'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            <label class="col-sm-3 col-form-label">Status</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="jabatan" class="form-control" readonly value="<?= $absen['status'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                            <label class="col-sm-3 col-form-label">Nama</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="nama" class="form-control" readonly value="<?= ucwords(strtolower($absen['nama'])) ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="kelas" class="form-control" readonly value="<?= $absen['nama_kelas'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-sm-12 col-lg-6">
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="jurusan" class="form-control" readonly value="<?= $absen['nama_jurusan'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-2">
